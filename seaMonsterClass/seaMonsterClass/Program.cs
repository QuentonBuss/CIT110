...

    {
...

        {
...

            {
                ...
                Console.WriteLine("\tE) Edit Monster Info");
...

                {
                    ...
                    case "E":
                    case "e":
                        DisplayEditMonsterInfo(seaMonsters);
                        break;
        ...
        static void DisplayEditMonsterInfo(List<SeaMonster> seaMonsters)
        {
            DisplayHeader("Sea Monster Info");
            string userResponse;
            bool monsterFound = false;
            ...
            foreach (SeaMonster seaMonster in seaMonsters)
            {
                ...
                {
                    monsterFound = true;
                    Console.WriteLine("A) " + seaMonster.Name);
                    Console.WriteLine("B) " + seaMonster.Weight);
                    Console.WriteLine("C) " + seaMonster.CanUseFreshWater);
                    Console.WriteLine("D) " + seaMonster.CurrentEmotionalState);
                    Console.WriteLine("E) " + seaMonster.HomeSea);
...

                    {
                        ...
                        Console.Write("Select A Property to Update:");
...

                        {
                            ...
                            case "A":
                            case "a":
                                Console.Write("Enter Monsters New Name: ");
                            ...
                            case "B":
                            case "b":
                                Console.Write("Enter Monsters New Weight: ");
                                double.TryParse(Console.ReadLine(), out double weight);
                            ...
                            case "C":
                            case "c":
                                Console.Write("Is Monster Freshwater Capable: ");
                                if (Console.ReadLine().ToUpper() == "YES")
                                {
                            ...
                            case "D":
                            case "d":
                                Console.Write("Enter Monsters New Emotional State: ");
                                Enum.TryParse(Console.ReadLine(), out SeaMonster.EmotionalState emotionalState);
                                break;

                            case "E":
                            case "e":
                                Console.Write("Enter Monsters New Home Sea: ");
